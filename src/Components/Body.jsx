...
const Body = () => {
    return (
        <div className="lg:flex ">
            ...
            <img src="./assets/Blue-Shape.svg" alt="1st" className="-rotate-[45deg] h-64 md:h-72 lg:h-[450px] lg:overflow-hidden" />
            <img src="./assets/Pink-Shape.svg" alt="2nd" className="absolute -rotate-[30deg] h-64 md:h-72 lg:h-[450px] lg:overflow-hidden"/>
            <img src="./assets/Purple-Shape.svg" alt="3rd" className="absolute -rotate-[15deg] h-64 md:h-72 lg:h-[450px] lg:overflow-hidden"  />
            ...
            <div className="space-y-4 lg:flex-1 lg:order-1 lg:space-y-10 ">
                ...
                <div className="flex gap-2 "><img src="./assets/Checkmark.svg" alt="check" />
